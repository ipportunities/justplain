...
const Buttons = (props) => {
  ...
  return (
    <div className="pageControls" style={{textAlign:"right"}}>
      ...
      {
        //Questionnaire met id 18 is onderdeel vd aanmelding KOO zelfhulp en wordt opgevolgd door questionnaire met ID 13, daarom dan volgende ipv afronden
        closeLesson ? <span className="btn btn-primary next" onClick={() => changeLesson(0, 0, 'end', true)}>{parseInt(questionnaire.id) === 18 ? t("Volgende") : t("Afronden vragenlijst")}</span> : ''
      }
