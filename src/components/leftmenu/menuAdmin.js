  ...
  return (
    <div>
      ...
      {appSettings.exam ?
        ...
        :''}
      <div className={ intervention.id !== undefined && intervention.id > 0 ? '' : 'hidden' }>
        <div className="pointer" onClick={ event => handleClick(event, '/intervention/edit/' + intervention.id + '/general/')}>
          <i className="fas fa-cog color_logo_orange"/>
        ...
        { appSettings.exportData === true ?
          <>
          <div className="pointer" onClick={ event => handleClick(event, '/intervention/data/' + intervention.id) } >
            <i className="fas fa-table color_logo_orange"/>
